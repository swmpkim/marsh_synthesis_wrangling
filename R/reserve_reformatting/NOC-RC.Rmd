...
```{r}
path_start <- here::here("submitted_data", "data", "NOC", "Rachel_Carson_component")
problem_path_out <- here::here("wrangled_data", "combined_with_issues")
path_out <- here::here("wrangled_data", "NOC_RC")
...
files_matching <- str_which(files_all, "NOC_RC_\\d{4}\\.xlsx")
...
```{r}
write.csv(dat_cdmo, here::here(problem_path_out, "NOC-RC_issues.csv"), 
          row.names= FALSE,
          na = "")
```
