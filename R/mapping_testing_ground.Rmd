...
test_coords <- data.frame(
    Reserve = rep("NAR_SETr", 6),
    SiteID = rep("COG", 6),
    TransectID = rep("T1", 6),
    PlotID = c("Cog 7", "Cog 8", "Cog 9", "Cog 10", "Cog 11", "Cog 12"),
    Lat = c(41.6502, 41.6497, 41.6508, 41.6507, 41.6531, 41.6528),
    Long = c(-71.342882, -71.342576, -71.340844, -71.340062, -71.342866, -71.343)
    )
test_coords <- bind_rows(test_coords, all_coords)
```
